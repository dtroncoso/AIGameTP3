...
function Behavior_Separation(game, posx, posy, key, frame, target) {
    ...
    this.min_speed = 0;
    //this.min_distance = 0;            //
    this.max_distance = 50;          //inicia el AREA de arrival

    return this;
}
Behavior_Separation.prototype = Object.create(Behavior.prototype);//Degfino que es sub clase de Sprite.
Behavior_Separation.prototype.constructor = Behavior_Separation;

Behavior_Separation.prototype.update = function () {
    if (game.input.mousePointer.isDown)
    {
        game.physics.arcade.moveToPointer(this.sprite, this.max_speed);
    }
    else
    {
        this.separate();
